    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
          <form>
              ...
              <p></p>
              <div class="from-group">
              <input type="radio" id="lakilaki" name="kelamin" value="Laki - Laki" required/>
              ...
              <div class="from-group">
              <select id="agama" name="agama" class="form-control form-control user" required>
              ...
              <br>
              <div class="from-group">
                  <textarea name="biograph" id="biograph" cols="30" rows="3" class="form-control form-control-user" required></textarea>
            ...
            if($biograph){
                echo "<strong>Biograph:</strong> {$biograph} <br>";
            }
              ?>
          </form>
            </div>
